    ...
    <div class="contenedor">
      <h1>Agenda de Contactos</h1>
        ...
        <div class="contenido existentes">
              ...
              <p>Resultados: <span id="total"></span> </p>
                    ...
                    <thead>
                        <tr>
                          ...
                          <th>
                            ...
                            <input type="checkbox" id="borrar_todos" name="">
                          </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <?php //dentro parentesis (MYSQLI_ASSOC, MYSQLI_NUM) ?>
                            <tr id="<?php echo $registros['id']; ?>">
                                  <td>
                                    ...
                                    <input type="text" value="<?php echo $registros['nombre']; ?>" name="contacto_<?php echo $registros['id']; ?>" class="nombre_contacto">
                                  </td>
                                  <td>
                                    <p><?php echo $registros['numero']; ?></p>
                                    <input type="text" value="<?php echo $registros['numero']; ?>" name="telefono_<?php echo $registros['id']; ?>" class="telefono_contacto">
